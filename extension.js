...
// ─── Metrics Dashboard (exp_009) ─────────────────────────────────────────────
// Visual dashboard for drift, state, autonomy metrics with real-time updates.
// Opened via scarlet.guardian.metrics command.
...
function activate(context) {
    ...
    context.subscriptions.push(
        ...
        vscode.commands.registerCommand('scarlet.guardian.metrics', () => {
            if (metricsPanel) metricsPanel.reveal();
...
if (process.env.SCARLET_TEST) {
    module.exports.__test = {
        POLICY, METRICS, ROLLING, DRIFT, PHANTOM, STATE_MODEL, VERIFICATION, STORAGE, METRICS_HISTORY,
        ...
        readJsonSafe, writeJsonSafe, logEvent, logDecision, getRecentDecisions, buildMetricsLine, pushMetricsHistory,
